...
(function (fn) {
    ...
    var getAttributes = function () {
        ...
        if (!langData) {
            data = {
                text: "Nosso website utiliza 'cookies'.",
                accept_text: "Aceitar",
                more_text: "Mais Informações",
                more_link: "../../politicaeprivacidade.html",
                reject_text: "Recusar",
                reject_info: null,
                reject_link: null,
                close_text: "Close",
    ...
    var warn = function () {
        ...
        var css = {
            style: [
                "#" + elementId + " {transition:all 0.4s ease-in-out;position:fixed;z-index:999999;bottom:-20px;left:0;right:0;opacity:0;text-align:center;padding:10px;background-color:#212121;color:white}",
                "#" + elementId + " .btn {white-space:nowrap;margin-top:20px;}",
            ...
            style2: [
                ...
                "#" + elementId + " a {text-decoration:none;color:#fff}",
            ],
            type: "text/css",
